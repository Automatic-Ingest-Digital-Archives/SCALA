...
Alternatively, you can [upload and ingest SIPs via HTTPS](https://github.com/Automatic-Ingest-Digital-Archives/SCALA/blob/main/RODA%20Ingestion%20Usings%20HTTPS.md), however it is not recommended.
